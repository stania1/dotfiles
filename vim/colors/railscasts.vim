...
if exists("syntax_on")
  ...
  hi Cursor                    guifg=#000000 guibg=#FFFFFF ctermfg=0 ctermbg=200	
  hi CursorLine                ctermbg=52 guifg=#520909 cterm=NONE
  hi Search                    guibg=#F5DB36 ctermfg=NONE ctermbg=236 
